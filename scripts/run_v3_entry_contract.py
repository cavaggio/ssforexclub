...
# Final contract assertions: tolerant patching is allowed, incomplete output is not.
required = {
    ...
    'server/v3AutoTrade.js': [
        "refreshIndependentV3CandidateForExecution",
        "execution skipped pair=",
    ],
    'server/executionPolicy.js': [
        "ENTRY_TIMING_STATUSES",
        "evaluateOpposingSweepBlock",
        "entryTiming must be populated",
    ],
    ...
    'server/primaryTimeframeAlignment.test.js': [
        "Daily/H4 disagreement hard-rejects",
    ],
    'server/v3EntryContract.integration.test.js': [
        "generated independent V3 candidate passes Stage 1 and Stage 2",
    ],
}
forbidden = {
